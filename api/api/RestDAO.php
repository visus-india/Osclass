...
class RestUser extends User {
    ...
    public function findUserByPrimaryKey($userId) {
        $this->dao->select("*");
...
//             $this->dao->where($this->getPrimaryKey(), $userId);
//             $result = $this->dao->get();
//             echo "after result " +$result->numRows() ;
//
//
//             if($result == false) {
//                 echo "after result in first if " +$result;
//                 return array();
//             }
//
//             if( $result->numRows() != 1 ) {
//                 echo "after result in second if " +$result;
//                 return array();
//             }
//
//             return $result->result();
        ...
        public function restEnabledUser()
        {
